...
interface ITempusAMM {
    ...
    function getExpectedReturnGivenIn(uint256 amount, bool yieldShareIn)
        external
        view
        returns (uint256);
    ...
    function getExpectedBPTInGivenTokensOut(
    ...
    function getExpectedLPTokensForTokensIn(uint256[] memory amountsIn)
        external
        view
        returns (uint256);
